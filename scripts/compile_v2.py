...
<body id="top" class="bg-tech-grid min-h-screen flex flex-col antialiased selection:bg-[#91372d] selection:text-white">
...
<!-- MAIN NAVIGATION BAR -->
    <div id="main-nav" class="backdrop-blur-md border-b transition-colors duration-300"
      ...
      <!-- Mobile Drawer -->
      <div id="mobile-menu" class="hidden lg:hidden border-t px-6 py-5 space-y-4 max-h-[calc(100vh-90px)] overflow-y-auto" style="background-color: var(--sv-paper-cream); border-color: var(--sv-border);">
        <div class="flex flex-col space-y-3 font-semibold text-sm">
          <a href="#katalogus" onclick="toggleMobileMenu()" class="py-1 text-stone-800 hover:text-[#91372d]" data-i18n="nav_catalog">Gasztro-Katalógus</a>
          <a href="#termekek" onclick="toggleMobileMenu()" class="py-1 text-stone-800 hover:text-[#91372d]" data-i18n="nav_products">Termékek & TDS</a>
          ...
          <a href="#egyedi-fejlesztes" onclick="toggleMobileMenu()" class="py-1 text-stone-800 hover:text-[#91372d]" data-i18n="nav_rd">Receptúra & Minták</a>
      ...
      <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
        ...
        <div class="flex flex-wrap items-center gap-1.5 sm:gap-2 p-1.5 rounded-xl border bg-white font-mono-spec text-xs max-w-full shadow-sm"
          ...
          <button onclick="switchCatalogTab('spreadable')" id="tab-btn-spreadable" data-i18n="cat_tab_spreadable"
                  class="catalog-tab px-3 py-2 rounded-lg font-semibold transition-all text-stone-700 hover:text-[#91372d] text-xs whitespace-nowrap">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div class="lg:col-span-6 space-y-6">
            ...
            <div class="space-y-2">
              ...
              <p id="cat-subtitle" class="text-sm text-[#91372d] font-semibold font-mono-spec">
      ...
      <div class="rounded-2xl p-6 sm:p-10 border flex flex-col lg:flex-row items-center justify-between gap-8"
        ...
        <div class="space-y-4 max-w-2xl text-center lg:text-left">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono-spec uppercase tracking-wider bg-white/10 text-[#FBBB9C]">
            <i data-lucide="file-presentation" class="w-3.5 h-3.5 text-[#91372d]"></i>
  ...
  <section id="mintakeres" class="py-16 md:py-24 border-b" style="border-color: var(--sv-border); background-color: var(--sv-surface);">
    <div class="max-w-4xl mx-auto px-4 sm:px-8">
      ...
      <div class="text-center max-w-2xl mx-auto mb-10">
        <div class="font-mono-spec text-xs uppercase tracking-widest text-[#91372d] font-semibold mb-2" data-i18n="form_section_tag">
      ...
      <form id="sample-request-form" onsubmit="handleSampleSubmit(event)" class="rounded-3xl border p-6 sm:p-10 shadow-lg space-y-6 transition-all"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input type="text" id="sample-name" name="contact_name" required 
                   ...
                   class="w-full px-4 py-3 rounded-xl border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#91372d] transition-all"
        ...
        <div>
          <div class="flex items-center gap-2">
            <input type="checkbox" id="form-gdpr" name="gdpr_consent" required class="w-4 h-4 rounded text-[#91372d] focus:ring-[#91372d]">
