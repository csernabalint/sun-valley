        ...
        <div class="lg:col-span-7 space-y-6">
          ...
          <div class="pt-2 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4">
            ...
            <a href="#kapcsolat" 
              ...
              <span data-i18n="hero_cta_sample">Kapcsolat & Gyári Minta Kérése</span>
            </a>
  ...
  <script>
    ...
    const translations = {
      hu: {
        ...
        btn_inquire_jam: "Érdeklődés & Gyári Minta Kérése",
        ...
        cat_img_caption_bake: "Üzemi próbasütési minta • Kelt tészta bukták 200 °C feletti sütés után, alaktartó töltelékkel",
      ...
      en: {
        ...
        btn_inquire_jam: "Inquire & Request Factory Sample",
        ...
        cat_img_caption_bake: "Industrial trial baking • Yeast dough buns baked above 200 °C with shape-retaining filling",
