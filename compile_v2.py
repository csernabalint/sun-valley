          ...
          <div class="rounded-2xl border shadow-xl relative overflow-hidden transition-all duration-300 group"
            ...
            <div class="p-5 sm:p-6 space-y-4">
              ...
              <div class="pt-1 flex items-center justify-between text-[10px] font-mono-spec text-stone-400">
                <span>MÓRI GYÁRI MINŐSÉG-ELLENŐRZÉS #SV-2026</span>
                <span class="text-[#E36527] font-semibold">KÖZVETLEN GYÁRI SZÁLLÍTÁS</span>
              </div>
            </div>
  ...
  <section class="border-b py-8 transition-colors" style="background-color: var(--sv-green-dark); color: #F5F2EE; border-color: var(--sv-border);">
    <div class="max-w-7xl mx-auto px-4 sm:px-8">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center md:text-left">
        ...
        <!-- Stat 1 -->
        <div class="space-y-1">
          <div class="font-syne font-extrabold text-base sm:text-2xl md:text-3xl text-[#FBBB9C]">1,1 – 1,3 Mrd Ft</div>
        ...
        <!-- Stat 3 -->
        <div class="space-y-1 md:border-l md:pl-6 border-white/10">
          <div class="font-syne font-extrabold text-base sm:text-2xl md:text-3xl text-[#E36527]">15+ Év</div>
        ...
        <!-- Stat 4 -->
        <div class="space-y-1 md:border-l md:pl-6 border-white/10">
          <div class="font-syne font-extrabold text-base sm:text-2xl md:text-3xl text-white">VEP Díjas</div>
          ...
          <div class="lg:col-span-6">
            <div class="relative rounded-2xl overflow-hidden border shadow-md bg-stone-100" style="border-color: var(--sv-border-light);">
              ...
              <div class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4 text-white text-xs font-mono-spec flex items-center justify-between">
                ...
                <span class="text-[#FBBB9C] font-semibold">MÓRI MINŐSÉG-ELLENŐRZÖTT</span>
              </div>
            </div>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="rounded-2xl border bg-white overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
          ...
          <div>
            <div class="h-48 overflow-hidden bg-stone-100 relative">
              <img src="assets/technology-baking-pastry-v2.png" alt="Sütésállósági teszt péksütemény" 
          ...
          <div class="p-5 pt-0 border-t mt-4 text-[11px] font-mono-spec text-[#E36527] font-semibold" style="border-color: var(--sv-border-light);" data-i18n="tech_bullet_1">
            ✓ Zéró tepsileégés
          </div>
        </div>
        ...
        <div class="rounded-2xl border bg-white overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
          ...
          <div>
            <div class="h-48 overflow-hidden bg-stone-100 relative">
              <img src="assets/technology-freezing-cake.png" alt="Fagyasztásálló gyümölcstöltelék" 
                   loading="lazy" decoding="async" class="w-full h-full object-cover">
          ...
          <div class="p-5 pt-0 border-t mt-4 text-[11px] font-mono-spec text-[#2D3628] font-semibold" style="border-color: var(--sv-border-light);" data-i18n="tech_bullet_2">
        ...
        <div class="rounded-2xl border bg-white overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
          ...
          <div>
            <div class="h-48 overflow-hidden bg-stone-100 relative">
              <img src="assets/technology-pumpable-doughnut.png" alt="Gépi pumpálható töltelék fánk injektálás" 
                   loading="lazy" decoding="async" class="w-full h-full object-cover">
          ...
          <div class="p-5 pt-0 border-t mt-4 text-[11px] font-mono-spec text-[#5F2125] font-semibold" style="border-color: var(--sv-border-light);" data-i18n="tech_bullet_3">
            ✓ Nem dugul el a tű
          </div>
        </div>
        ...
        <div class="rounded-2xl border bg-white overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
          ...
          <div>
            <div class="h-48 overflow-hidden bg-stone-100 relative">
              <img src="assets/custom-recipe-jam-sizes.png" alt="Ipari kiszerelések vödörtől hordóig" 
                   loading="lazy" decoding="async" class="w-full h-full object-cover">
          ...
          <div class="p-5 pt-0 border-t mt-4 text-[11px] font-mono-spec text-emerald-700 font-semibold" style="border-color: var(--sv-border-light);" data-i18n="tech_bullet_4">
            ✓ Raklapos paritás
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8 space-y-6">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-4 border-b pb-6 border-white/10">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-[10px] text-white/60">Ipari Gyümölcstechnológia Mór • Alapítva 2009</div>
          </div>
        </div>
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-white/50">
        ...
        <div class="flex items-center gap-4">
          <span>AA+ Pénzügyi Minősítés</span>
          <span>•</span>
          <span>ISO / HACCP Szabvány</span>
          <span>•</span>
          <span>Móri Gyártóbázis</span>
        </div>
      </div>
  ...
  <script>
    ...
    const translations = {
      hu: {
        ...
        tech_bullet_1: "✓ Zéró tepsileégés",
        ...
        tech_bullet_2: "✓ Fagyasztási stabilitás",
        ...
        tech_bullet_3: "✓ Nem dugul el a tű",
        ...
        tech_bullet_4: "✓ Raklapos paritás",
      ...
      en: {
        ...
        cat_tab_spreadable: "2. Cold-Spreadable",
        ...
        tech_bullet_1: "✓ Zero pan scorching",
        ...
        tech_bullet_2: "✓ Freeze-thaw stable",
        ...
        tech_bullet_3: "✓ Clog-free nozzle dosing",
        ...
        tech_bullet_4: "✓ Palletized logistics",
      ...
      de: {
        ...
        tech_bullet_3: "✓ Kein Verstopfen der Dosiernadel",
        ...
        tech_bullet_4: "✓ Palettengerechte Logistik",
    ...
    // ---------------------------------------------------------------------------
    // KATALÓGUS DATA (TABBED FLIPBOOK WITH FULL MULTILINGUAL FIELDS)
    // ---------------------------------------------------------------------------
    const catalogData = {
      "bake-stable": {
        ...
        apps: {
          ...
          de: ["Aprikosenbuchteln", "Plunder-Taschen", "Linzer Schnitten", "Blätterteigtaschen", "Pasteten & Strudel"]
        },
        specs: {
          heat: "≥ 200 °C",
          brix: "58–64° Brix",
        ...
        caption: {
          hu: "Üzemi próbasütési minta • 10 kg tömbösített kiszerelés",
          en: "Industrial pilot batch sample • 10 kg solid block format",
          de: "Betriebliches Probemuster • 10 kg Blockgebinde"
        },
        tdsIndex: 0
      },
      "spreadable": {
        ...
        caption: {
          hu: "Hidegen kenhető málnás & erdei gyümölcsös minták • 5 kg vödör",
          en: "Cold-spreadable raspberry & forest fruit samples • 5 kg bucket",
          de: "Kalt streichfähige Himbeer- & Waldbeer-Muster • 5 kg Eimer"
        },
        tdsIndex: 2
      },
      "extra-jam": {
        ...
        caption: {
          hu: "Extra meggyes & barackos sütemény fotók • Prémium minőség",
          en: "Extra sour cherry & apricot pastry proof • Gourmet quality",
          de: "Extra Sauerkirsch- & Aprikosen-Feingebäck • Premiumqualität"
        },
        tdsIndex: 4
      }
    };
    ...
    function renderCatalogTab() {
      ...
      // Image & localized caption
      const img = document.getElementById('cat-image');
      img.src = data.image;
      document.getElementById('cat-img-caption').innerText = data.caption[currentLang] || data.caption.hu;
        ...
        <div class="space-y-6">
          ...
          <div class="border-b pb-4">
            <div class="flex items-center gap-2 text-xs font-mono-spec text-[#E36527] font-semibold uppercase">
              <span>SUN VALLEY ZRT. • MÓRI GYÁR</span>
              <span>•</span>
              <span>MŰSZAKI ADATLAP #TDS-2026</span>
            </div>
